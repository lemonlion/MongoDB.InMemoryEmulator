...
internal static class MongoErrors
{
    ...
    // WriteError and BulkWriteError have internal constructors in global::MongoDB.Driver 2.30.0.
    ...
    internal static WriteError CreateWriteError(ServerErrorCategory category, int code, string message, BsonDocument? details = null)
    {
        if (WriteErrorCtor == null)
            throw new InvalidOperationException(
                "Could not find WriteError internal constructor. global::MongoDB.Driver version may have changed.");
    ...
    internal static BulkWriteError CreateBulkWriteError(int index, ServerErrorCategory category, int code, string message, BsonDocument? details = null)
    {
        if (BulkWriteErrorCtor == null)
            throw new InvalidOperationException(
                "Could not find BulkWriteError internal constructor. global::MongoDB.Driver version may have changed.");
    ...
    internal static BulkWriteUpsert CreateBulkWriteUpsert(int index, BsonValue id)
    {
        if (BulkWriteUpsertCtor == null)
            throw new InvalidOperationException(
                "Could not find BulkWriteUpsert internal constructor. global::MongoDB.Driver version may have changed.");
        ...
        IReadOnlyList<WriteModel<TDocument>> processedRequests)
    {
        ...
        if (ackType == null)
            throw new InvalidOperationException(
                "Could not find BulkWriteResult.Acknowledged nested type. global::MongoDB.Driver version may have changed.");
        ...
        if (ctor == null)
            throw new InvalidOperationException(
                "Could not find BulkWriteResult.Acknowledged constructor. global::MongoDB.Driver version may have changed.");
    ...
    /// <summary>
    /// Error for $rename across an array element.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal static MongoWriteException RenameTraversesArray(string field)
    {
        var writeError = CreateWriteError(ServerErrorCategory.Uncategorized, 2,
            $"The source field for $rename may not traverse an array element: {field}");
        return new MongoWriteException(SyntheticConnectionId, writeError, writeConcernError: null, innerException: null);
    }
    ...
    /// </remarks>
    internal static MongoCommandException CannotRemoveFromCapped()
    {
        return new MongoCommandException(
            SyntheticConnectionId,
    ...
    /// </remarks>
    internal static MongoCommandException DocumentTooLarge(int actualSize, int maxSize)
    {
        return new MongoCommandException(
            null!,
            $"Document exceeds maximum size of {maxSize} bytes (actual: {actualSize})",
            new BsonDocument("ok", 0));
    }
}
